...
internal sealed partial class FeedAutomationMediaActionBackgroundService(
    IFeedAutomationMediaActionProcessor processor,
    FeedAutomationActionProcessorOptions options,
    ILogger<FeedAutomationMediaActionBackgroundService> logger)
    : BackgroundService
{
    ...
    [LoggerMessage(
        1601,
        LogLevel.Debug,
        "Processed {AttemptedCount} media Feed automation actions")]
    ...
    [LoggerMessage(
        1602,
        LogLevel.Warning,
        "The media Feed automation action queue pass failed")]
