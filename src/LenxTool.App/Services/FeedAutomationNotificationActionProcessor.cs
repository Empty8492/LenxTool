    ...
    : IFeedAutomationNotificationActionProcessor
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            switch (result)
            {
                case FeedAutomationNotificationActionResult.Completed:
                    await TryCompleteAsync(
                        ...
                        cancellationToken).ConfigureAwait(false);
                    break;
                case FeedAutomationNotificationActionResult.EntryMissing:
                    await TryCompleteAsync(
                        action,
                        ...
                        cancellationToken).ConfigureAwait(false);
                    break;
                case FeedAutomationNotificationActionResult.FeedUnavailable:
                    await TryCompleteAsync(
                        action,
                        FeedAutomationActionRunOutcome.Failed,
                        "POLICY_DISABLED",
