...
- 代码与假 HTTP 契约无剩余 P0/P1。生产 D1 migration、Worker v2、首管理员、策略 schema v2/兼容契约、Desktop/qBittorrent 全部真实 canary，以及全仓 formatter 基线已完成；尚未完成的是真实 Readeck/Outline/Webhook、签名安装包和跨物理机升级矩阵。
