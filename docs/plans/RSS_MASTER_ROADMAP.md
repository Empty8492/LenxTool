...
状态：Gate 0、P0、P1、P2-01～P2-14、P2-16～P2-23、DISC-01～DISC-06 与 UX-03 已完成；P2-15 已取消实施，P2-D 外部真实连通仍开放
最后核对：2026-08-13
...
| 4 | [P2：内容视图、导出与定时摘要](RSS_P2_VIEWS_INTEGRATIONS.md) | 多内容视图、外部导出、Windows 通知和摘要 | 进行中；P2-01～P2-14、P2-16～P2-23 已完成，P2-15 已取消，P2-D 外部真实连通仍开放 |
...
6. 统一发现与原生控件视觉插入计划已经关闭，P2-01～P2-14 已验收；P2-15 Cubox 因能力重叠和官方重试契约不足取消实施；P2-16～P2-19 已按独立垂直切片交付自动化实现，真实服务验收仍由 P2-D 单独控制；P2-23 选择“不扩权”关闭。
...
- Markdown、Obsidian、Eagle、Zotero、Readwise、Readeck、Outline、qBittorrent 与受控 Webhook 已按统一导出接口完成；Cubox 已取消实施。qBittorrent 与 Webhook 真实 P2-D 矩阵已通过，Eagle/Zotero/Readwise/Readeck/Outline 仍需受控真实验收。
