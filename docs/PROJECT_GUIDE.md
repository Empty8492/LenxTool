...
- 安全 Feed URL 发现、通用条目解析、抓取调度、OPML 管理、只读时间线、Feed 健康诊断、首页真实数据聚合、全文/图片离线、附件分类与安全外链、自动化规则发布边界、本地运行账本、规则同步、受限状态动作与 AI 摘要/翻译动作已实现；Feed 媒体投递、通知动作、规则管理和外部导出仍待后续任务。
